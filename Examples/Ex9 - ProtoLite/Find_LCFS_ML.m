function Find_LCFS_ML(A_phi_total, y, Z, X, data1,ds)
...
%        Update maximum radial extent from valid segments
    ...
    fluxLevels = linspace(-12, ds.C_min, 30); % Final flux levels
    ...
    for j = 1:length(X)
        ...
        text( X(j), R1(j)+0.5*dR, sprintf('%.0f A',Icoil), ...
            'Color','w', ...
            'FontSize',8, ...
            'FontWeight','bold', ...
        ...
        text( X(j), -R2(j)+0.5*dR, sprintf('%.0f A',Icoil), ...
            'Color','w', ...
            'FontSize',8, ...
            'FontWeight','bold', ...
            'HorizontalAlignment','center', ...
    ...
    ylabel('Radial Distance (m)','FontWeight','bold');
    title('Magnetic Flux and Device Geometry','FontWeight','bold');
