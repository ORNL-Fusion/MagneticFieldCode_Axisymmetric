function generate_Bfield_opt(currents)
...
coilCurrents{1}.TR1 = currents(1); %530;
coilCurrents{1}.TR2 = currents(2); %2100;
coilCurrents{1}.PS1 = currents(3); %6800;
coilCurrents{1}.PS2 = currents(4); %3500;
coilCurrents{1}.PS3 = currents(5); %430;
