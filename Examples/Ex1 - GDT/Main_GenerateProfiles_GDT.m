% OBJECTIVE:
% Calculate the magnetic field profile and 2D plasma density profiles for a
% GDT device using the functions created in this repo
...
% The geometry of the coils can be defines either using:
% 1- Excel spreadsheet called "coilSetup_GDT" or 
% 2- A script called "GenerateCoilSetup"
...
switch coilSetupType
    ...
    case 2
        % Use "GenerateCoilSetup" script to define coil geometry
        dum1 = tic;
...
% Based on "coilSetup" and "coilCurrents", we produce a structure called
% "coil" for each physical coil. The "coil" structure contains the position
% of each current filament loop, power supply current and current per loop.
